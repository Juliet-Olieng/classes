...
class Car{
    ...
    let car1=new Car("Jeep","Campass",2020,`False`)
    console.log(car1)
...
class Rental{
    ...
    calculateRentalDuration(){
        let rentalDuration=Math.round(Math.abs(this.rentalEndDate-this.rentalStartDate))/
        (1000*40*40*24)
...
let car=new Car('Ford','Bronco',2022,true)
console.log(car);

let rental=new Rental('subaru','juliet',new Date('4/5/2023'),new Date('4/7/2023'))
console.log(rental)
...
let question=new Question("who is the president of kenya",["uhuru","ruto","raila"],"ruto")
let userAnswer="raila"
...
class Quiz{
    ...
    let quiz1=new Quiz()
    let question1=new Question("Which is the capital city of kenya",["Nairobi","Mombasa","Nakuru"],"Nairobi")
    let question2=new Question("Who is the deputy president of kenya",["Rigathi","ruto","kalonzo"],"Rigathi")
    quiz1.addQuestion(question1)
    quiz1.addQuestion(question2)
    quiz1.submitAnswer("Nairobi")
    quiz1.nextQuestion()
    quiz1.submitAnswer("ruto")
